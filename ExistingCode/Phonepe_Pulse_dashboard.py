...
conn = pymysql.connect(host='localhost', user='root', password='', db='phonepe')
cursor = conn.cursor()
...
# ==============================================          /     Top categories       /             =========================================== #
    ...
    with tab5:
        ...
        cursor.execute(f"SELECT State, SUM(Transaction_amount) As Transaction_amount FROM top_trans WHERE Year = '{top_tr_yr}' GROUP BY State ORDER BY Transaction_amount DESC LIMIT 10;")
        ...
        cursor.execute(f"SELECT State, SUM(Transaction_amount) as Transaction_amount, SUM(Transaction_count) as Transaction_count FROM top_trans WHERE Year = '{top_tr_yr}' GROUP BY State ORDER BY Transaction_amount DESC LIMIT 10;")
