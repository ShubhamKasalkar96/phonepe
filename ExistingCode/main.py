...
st.set_page_config(page_title= "Phonepe Pulse Data Visualization",
                   ...
                   menu_items={'About': """# ThisData has been cloned from Phonepe Pulse Github Repository"""})
...
# MENU 1 - HOME
if selected == "Home":
    st.image("F:\Shubham\python\PhonepePluse\image\home.png")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv('F:\Shubham\python\PhonepePluse\File\state_names.csv')
            df1.State = df2
